...
with s1:
    ...
    metric_card("% fora do SLA", sla_rate)
with s2:
    avg_sla = filtered["sla_previsto_horas"].dropna().mean()
    metric_card("SLA médio previsto", f"{avg_sla:.1f} h" if pd.notna(avg_sla) else "N/D")
with s3:
